...
$rm_send_address[] = 'contact.atmark@gmail.com';
...
//【任意】 自分に届くメールの題名
$rm_send_subject = 'でいすいのホームページへのお問い合わせ';
...
$rm_send_name = 'あっとまーく/atmark';




//【任意】 相手に届く自動返信メールの題名
$rm_thanks_subject = 'お問い合わせありがとうございます';
...
この度はでいすいのホームページへお問い合わせをいただき、ありがとうございました。
管理者が内容を確認の後、でいすいと内容を共有いたします。場合によりましては返信をさせていただきます。
...
以上、サイト管理者 あっとまーく/atmark が受付いたしました。
-----------------------------------------------------------------------------------

　　でいすいのホームページ お問い合わせ担当者
   あっとまーく/atmark
　　contact.atmark@gmail.com
　　https://atmark-master.themedia.jp
